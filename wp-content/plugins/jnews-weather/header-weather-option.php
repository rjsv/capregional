...
$options[] = array(
    ...
    'description'   => wp_kses(sprintf(__("With this option, your website will use <a href='%s' target='_blank'>ipinfo.io</a> and <a href='%s' target='_blank'>ipdata.co</a> to get client IP and detect the location. You can use this option wihtout using their API key with very <strong>limited</strong> request", "jnews-weather"), "https://ipinfo.io/", "https://ipdata.co/"), wp_kses_allowed_html()),
    'partial_refresh' => array(
