...
Class Element_Newsticker_View extends ModuleViewAbstract
{
    ...
    {
        if ( ! is_admin() ) {
            wp_enqueue_style( 'jnews-newsticker', get_parent_theme_file_uri( 'assets/' ) . 'css/jnewsticker.css', null, wp_get_theme()->get('Version') );
            wp_enqueue_script( 'jnews-newsticker', get_parent_theme_file_uri( 'assets/' ) . 'js/jquery.jnewsticker.js', array( 'jquery' ), wp_get_theme()->get('Version'), true );
        }
