...
Class Slider_Overlay_View extends SliderViewAbstract
{
    ...
    public function render_element($result, $attr)
    {
        ...
        {
             if ( ! is_admin() ) {
                wp_enqueue_style( 'jnews-overlayslider', get_parent_theme_file_uri( 'assets/' ) . 'css/joverlayslider.css', null, wp_get_theme()->get('Version') );
                wp_enqueue_script( 'jnews-overlayslider', get_parent_theme_file_uri( 'assets/' ) . 'js/jquery.joverlayslider.js', array( 'jquery' ), wp_get_theme()->get('Version'), true );
            }
